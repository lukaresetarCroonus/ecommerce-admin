...
const PromotionsUpsellsDetails = () => {
    ...
    const { rid } = useParams();
    const apiPath = "admin/sell-strategies/up-sell/basic-data";
        ...
        api.post(apiPath, data)
            .then((response) => {
                ...
                if (oldId === null) {
                    ...
                    navigate(`/promotions/promotions-up-sells/${tId}`, { replace: true });
                }
    ...
    const panelHandleSelect = (field) => {
        ...
        navigate(`/promotions/promotions-up-sells/${id}?${queryString}`, { replace: true });
    };
...
export default PromotionsUpsellsDetails;
