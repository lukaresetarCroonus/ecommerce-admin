...
const ChartTabs = () => {
  ...
  const { api } = authCtx;
  const orderCountChart = "admin/dashboard/b2c/order-count-chart";
  const orderAmountChart = "admin/dashboard/b2c/order-amount-chart";
  const productItemSellCountChart = "admin/dashboard/b2c/product-item-sell-count-chart";
