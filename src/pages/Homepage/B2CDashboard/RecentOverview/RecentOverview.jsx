...
const RecentOverview = ({ recentOverviewB2C, isLoadingRecentOverviewB2C }) => {
        ...
        <>
          ...
          <CardContent>
            {isLoadingRecentOverviewB2C ? (
              ...
              <TableContainer>
                {recentOverviewB2C?.items?.length ?
                  <Table className="dashboardTable">
                    <TableBody>
                      {recentOverviewB2C?.items.map((row) => (
