...
const SelectionModal = ({ openDialog, setOpenDialog, selectedValues, component, opt, options, setOptions, onChange, inputType, isLoadingOpt, save }) => {
        ...
        >
            <Box sx={{ padding: "2rem" }}>
                ...
                {save?.button && (
                    <Button
                        type="submit"
                        label={save?.isPending ? <CircularProgress size="1.5rem" /> : "Sačuvaj"}
                        variant="contained"
                        onClick={save?.fnc}
